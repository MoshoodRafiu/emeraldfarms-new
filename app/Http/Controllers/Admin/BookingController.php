...
class BookingController extends Controller
{
    ...
    public function approve(Booking $booking)
    {
        ...
        $title= ' ';
        $name = $user->name;
        $content = "Your Booking in {$booking->farm->title} has been approved. NGN {$booking->amount} has been added to your Emerald bank.";
        $button = false;
        $button_text = '';
    ...
    public function decline(Booking $booking)
    {
        ...
        $title= ' ';
        $name = $user->name;
        $content = "Your Booking in {$booking->farm->title} has been declined. Please reach out to the admin if this is a mistake.";
        $button = false;
        $button_text = '';
