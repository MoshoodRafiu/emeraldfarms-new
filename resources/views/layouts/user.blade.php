        ...
        <nav class="navbar navbar-expand-lg main-navbar sticky">
            <div class="form-inline mr-auto">
                <ul class="navbar-nav mr-3">
                    ...
                    <li>
                        <a href="#" class="nav-link" style="color:#9a9a9b"> Active Investments: <span class="badge badge-success"><big>₦{{ number_format(auth()->user()->totalInvestmentsAmount(),2) }}</big></span> <span class="d-sm-none d-lg-inline-block"></span></a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div style="background-color:;" class="alert alert-danger">
                                ...
                                <strong>Account Number:</strong> 1223409539 <br>
                                <strong>Account Name:</strong> Emerald Farms & Consultant Ltd. <br>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div style="background-color:;" class="alert alert-danger">
                                ...
                                <label><strong>Bank Name</strong> Access Bank </label>
                                <label><strong>Account Number:</strong> 1223409539 </label> <br>
                                <label><strong>Account Name:</strong> Emerald Farms & Consultant Ltd. </label> <br>
                            </div>
                            <hr>
