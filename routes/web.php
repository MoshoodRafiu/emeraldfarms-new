...
Route::group(['prefix' => 'admin','middleware' => 'assign.guard:admin,admin/login'],function(){
    ...
    Route::group(['middleware' => 'manageradmin.only'], function(){
        ...
        Route::post('/farmlist/edit', 'AdminController@editFarmlistPost')->name('farmlist.edit');
...
Route::group(['middleware' => 'assign.guard:web,/login'],function(){
    ...
    Route::post('/bank/edit/{id}', 'HomeController@editBankPost')->name('bank.update');
    ...
    Route::get("/transactions/{type}/download", 'TransactionsController@download')->name('download.user.transactions');
